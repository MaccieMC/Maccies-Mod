...
public class Food extends ItemFood implements ITextureProvider
{
    ...
    public Food(int par1, int par2, boolean par3)
    {
     ...
     */
    public Food setPotionEffect(int par1, int par2, int par3, float par4)
    {
        this.potionId = par1;
	...
	public String getTextureFile() {
		...
		return "/maccie/mod/items/food.png";
	}
}
