...
public class Pane extends BlockPane implements ITextureProvider
{
    /**
    ...
    public Pane(int par1, int par2, int par3, Material par4Material, boolean par5)
    {
   ...
   /* public final boolean canThisPaneConnectToThisBlockID(int par1)
	...
	public String getTextureFile() {
		...
		return "/maccie/mod/blocks/other.png";
	}
}
