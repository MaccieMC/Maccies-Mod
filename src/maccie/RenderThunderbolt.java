...
public class RenderThunderbolt extends Render
{
    /**
    ...
    public RenderThunderbolt(int par1)
    {
    ...
    public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        ...
        this.loadTexture("/maccie/mod/items/magic.png");
        Tessellator var10 = Tessellator.instance;

        if (this.itemIconIndex == 0)
        {
           // int var11 = PotionHelper.func_40358_a(((EntityPotion)par1Entity).getPotionDamage(), false);
            float var12 = (float)(/*var*/11 >> 16 & 255) / 255.0F;
            float var13 = (float)(/*var*/11 >> 8 & 255) / 255.0F;
            float var14 = (float)(/*var*/11 & 255) / 255.0F;
